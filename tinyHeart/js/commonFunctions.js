...
window.requestAnimFrame = (function() {		//requestAnimationFrame兼容
...
function calLength2(x1, y1, x2, y2) {		//计算大鱼与果实之间的距离
...
function lerpAngle(a, b, t) {			//与大鱼旋转角度有关的函数
	var d = b - a;
...
function lerpDistance(aim, cur, ratio) {   //aim表示目标位置，cur表示当前位置，ratio表示百分比
	var delta = cur - aim;
	return aim + delta * ratio;				//按比例靠近目标位置
}
